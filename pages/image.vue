        ...
        >
          ...
          <div class="col-span-12 lg:col-span-2">
            ...
            <Select v-model="resolution">
              ...
              <SelectContent>
                <SelectGroup>
                  <SelectItem v-for="(res, i) in resolutionOptions" :value="res.value" :key="i">
                    {{ res.text }}
                  </SelectItem>
                </SelectGroup>
              </SelectContent>
          ...
          <div class="col-span-12 lg:col-span-2">
            <Select v-model="amount">
              ...
              <SelectContent>
                <SelectGroup>
                  <SelectItem v-for="(res, i) in amountOptions" :value="res.value" :key="i">
                    {{ res.text }}
                  </SelectItem>
                </SelectGroup>
              </SelectContent>
...
const submitPrompt = async () => {
  ...
  if (data.value) {
    photos.value = data.value.map((img: any) => {
